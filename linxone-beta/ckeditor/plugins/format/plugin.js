...
/**
 * The style definition to be used to apply the `'Code'` format.
 *
 *		config.format_code = { element: 'code', attributes: { 'class': '' } };
 *
 * @cfg {Object} [format_code={ element: 'code' }]
 * @member CKEDITOR.config
 */
CKEDITOR.config.format_code = { element: 'code' };
