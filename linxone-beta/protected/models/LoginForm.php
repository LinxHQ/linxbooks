...
class LoginForm extends CFormModel
{
	...
	public $rememberMe;
        public $error;
        public $account_check_social_login_id_facebook;
        public $account_check_social_login_id_google;
	...
	public function login()
	{
        ...
        public function loginSocialFacebook(){
            ...
            if($this->_identity===null)
            {
                ...
                $this->_identity->authenticateSocialFacebook();
            }
//            return $this->_identity->errorCode;
        ...
        public function loginSocialGoogle(){
            ...
            {
                $this->_identity=new UserIdentity($this->username,"");
                $this->_identity->authenticateSocialGoogle();
            }
//            return $this->_identity->errorCode;
            if($this->_identity->errorCode===UserIdentity::ERROR_NONE)
            {
