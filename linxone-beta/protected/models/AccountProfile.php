 ...
 */
class AccountProfile extends CActiveRecord
{
	...
	{
		return 'lb_sys_account_profiles';
	}
	...
	public function rules()
	{
		...
		return array(
			// array('account_id, account_profile_surname, account_profile_given_name', 'required'),
			// update ko bat buoc nhap account_profile_surname
			array('account_id, account_profile_given_name', 'required'),
