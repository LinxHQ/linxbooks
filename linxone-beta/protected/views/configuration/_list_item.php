       ...
       // 'htmlOptions' => array('class'=>'items table table-bordered','width'=>'98%'),
        'columns'=>array(
                        array(
                            ...
                            'type'=>'raw',
                            'value' =>
                            'CHtml::link(Yii::t("lang",$data->system_list_code),Yii::app()->createUrl("configuration/list_item",array("list"=>$data->system_list_code)))'
                            ),
                        array(
                            'class'=>'CButtonColumn',
...
echo '<div class="btn-toolbar" id ="new_item">';
      LBApplicationUI::newButton(Yii::t('lang','New List'), array());
echo '</div>';
...
<div hidden ="true" id="form-new-item" class="accordion-body collapse in">
    <input type="text" value="" id="new"><lable id ="err"></lable>
                    ...
                    <?php 
                        echo '<div id ="newItem">';
                        echo CHtml::Button(Yii::t('lang','Insert'),array('onclick'=>'load_item();return false;','class'=>'btn','style'=>'margin-top:-3px;')); 
                        echo '</div>';
                    ?>
