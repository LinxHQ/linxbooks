...
class UserSubscriptionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['UserSubscription'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->user_subscription_id));
		}
	...
	{
//		$dataProvider=new CActiveDataProvider('UserSubscription');
//                
//                include 'SubscriptionController.php';
//                $sub = SubscriptionController::loadModel(1);
//                include 'UsersController.php';
//                $user = UsersController::loadModel(2);
//                
//		$this->render('index',array(
//			'dataProvider'=>$dataProvider, 'sub'=>$sub, 'user'=>$user
//		));
                
                $data = self::getListUserSub();
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['UserSubscription']))
			$model->attributes=$_GET['UserSubscription'];
                    ...
                    LBApplication::renderPartial($this,'admin',array(
			'model'=>$model,
		));
	}
	...
	{
		$model=UserSubscription::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-subscription-form')
		{
