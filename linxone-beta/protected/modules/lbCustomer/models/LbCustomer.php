 ...
 * @property integer $lb_customer_type
 */
class LbCustomer extends CLBActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('lb_customer_type', 'length', 'max'=>30),
			array('lb_customer_registration, lb_customer_tax_id', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('lb_record_primary_key, lb_customer_name, lb_customer_registration, lb_customer_tax_id, lb_customer_website_url, lb_customer_is_own_company, lb_customer_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'lb_customer_type' => Yii::t('lang', 'Customer Type'),
		);
	}
