...
echo '</div><br>';
    ...
    echo '<div style="margin-top:18px;">';
        ...
        echo CHtml::dropDownList('lb_category_id', '', array(''=>Yii::t('lang','All'))+UserList::model()->getItemsListCodeById('expenses_category', true), array('style'=>'width:150px;'));echo '&nbsp;&nbsp;&nbsp;';
        ...
        echo '&nbsp;&nbsp;&nbsp;';
        echo '<button class="btn" name="yt0" type="submit" onclick = "searchExpenses()" style="margin-top:-10px">'.Yii::t('lang','Search').'</button>';
