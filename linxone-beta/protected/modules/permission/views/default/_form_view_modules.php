...
$str_js = "
        ...
        $('#lb-module-grid table.items tbody').sortable({
            ...
            items: 'tr',
            update : function () {
                serial = $('#lb-module-grid table.items tbody').sortable('serialize', {key: 'items[]', attribute: 'class'});
                $.blockUI();
                $.ajax({
...
<?php
    $this->widget('bootstrap.widgets.TbGridView',array(
        'id'=>'lb-module-grid',
        'template' => "{items}\n{pager}\n{summary}",
        'rowCssClassExpression'=>'"items[]_{$data->lb_record_primary_key}"',
