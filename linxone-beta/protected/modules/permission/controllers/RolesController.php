...
class RolesController extends CLBController
{
	/**
            ...
            return array(
                array('allow', // allow authenticated user to perform 'create' and 'update' actions
                        'actions'=>array('admin','create','update','AjaxAddLineRole','delete','index','view','deleteRole','assingPermissionRoles',
                            'updateBasicPermissionRoles','reloadRolesBasicPermission','deleteModuleRole', 'updateDefinePerRole','ajaxUpdateField'),
                        'users'=>array('@'),
                ),
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionAjaxAddLineRole()
        {
            if(isset($_POST['role_name']))
            {
                ...
                $role->role_module_home = 0;
                $role->role_module_home_action = '';
                if($role->save())
                    echo '{"status":"success"}';
                else
                    echo '{"status":"error"}';
