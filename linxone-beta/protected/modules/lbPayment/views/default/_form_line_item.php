<?php 
//$invoice = $lbInvoiceModel->getInvoiceByCustomer(5);
//print_r($invoice);
//echo $invoice->lb_invoice_no;
$invoice = $lbInvoiceModel->getInvoiceAmountByCustomer($customer_id);
		...
		'columns' => array(
				array(
                                ...
                                array(
                                        ...
                                        //'name'=>'lb_invoice_no',
                                        'type' => 'raw',
                                        'value' =>'CHtml::encode($data->lb_invoice_no)',
                                ...
                                array(
                                        ...
                                        'type' => 'raw',
                                        'value' =>'CHtml::textField("amount_due_{$data->lb_record_primary_key}",LbInvoiceTotal::model()->getInvoiceTotal("{$data->lb_record_primary_key}")->lb_invoice_total_outstanding,array(
...
<?php if(count($invoice->data)){ ?>
    <div style="width:100%;overflow:hidden;margin-bottom: 50px;text-align: right;font-weight: bold;">
        ...
        <div style="float:left;width:167px;" id="total_payment_amount"><?php echo LbInvoiceTotal::model()->getTotalInvoiceByCustomer($customer_id) ?></div>
...
<script>
    ...
    function save_payment(){
       ...
       $.ajax({
           type:'POST',
           url:'<?php echo yii::app()->createUrl('lbPayment/default/AjaxSavePayment')?>',
           data:data_form,
