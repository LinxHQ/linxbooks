...
if (isset($submission_details) && $submission_details["type"] == 'ajax')
{
    LBApplicationUI::submitButton('Save', array(
        'url'=> $model->getActionURLNormalized('createTax',
            array('ajax'=>1,'form_type'=>'ajax', 'auto_add'=>'1','invoice_id'=>$invoiceModel->lb_record_primary_key)),
