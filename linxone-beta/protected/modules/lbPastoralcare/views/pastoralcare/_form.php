...
<?php 
	echo '<div id="lb-container-header">';
        ...
        // echo '<div class="lb-header-left">';
	       ...
	       //  	echo '<a live="false" data-workspace="1" href="'.$this->createUrl('/lbPastoralcare/pastoralcare/create').'"><i style="margin-top: -12px;margin-right: 10px;" class="icon-plus"></i> </a>';
