...
//		}
		...
		// check permission
		// only master account or owner account can update profile
		if ($id != Yii::app()->user->id
			&& AccountSubscription::model()->getSubscriptionOwnerID(LBApplication::getCurrentlySelectedSubscription()) != Yii::app()->user->id)
		{
			throw new CHttpException(401,'You are not given the permission to view this page.');
			return false;
		}
