...
require_once(dirname(__FILE__).'/config_id_facebook.php');
require_once(dirname(__FILE__).'/config_id_google.php');
...
//				//'viewPath' => 'application.views.mails',
                    ...
                    'eauth' => array(
                        ...
                        'services' => array( // You can change the providers and their classes.
                            'google_oauth' => array(
                                ...
                                'client_id' => $social_api_google['api_id_google'],
                                'client_secret' => $social_api_google['api_secret_google'],
                                'title' => 'Login with Google',
                            ),
                            'facebook' => array(
                                // register your app here: https://developers.facebook.com/apps/
                                'class' => 'FacebookOAuthService',
                                'client_id' => $social_api_facebook['api_id_facebook'],
                                'client_secret' => $social_api_facebook['api_secret_facebook'],
	...
	'params'=>array(
		'isDemoApp' => 0,// if set to 1 (true) certain feature will be turned off such as update password(
		// this is used in contact page
		'adminID'=>1,
		'noReplyEmail' => 'no-reply@linxbooks.com',
