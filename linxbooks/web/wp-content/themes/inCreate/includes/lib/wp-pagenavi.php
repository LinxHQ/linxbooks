...
/*function pagenavi_menu() {
	if (function_exists('add_menu_page')) {
		add_options_page(__('PageNavi', 'highthemes'), __('PageNavi', 'highthemes'), 'manage_options', 'wp-pagenavi/pagenavi-options.php') ;
	}
}*/
...
function pagenavi_stylesheets() {
	if(@file_exists(get_template_directory().'/pagenavi-css.css')) {
...
function pagenavi_init() {
    global $pagenavi_options;
	//pagenavi_textdomain();
	// Add Options
	$pagenavi_options = array();
	$pagenavi_options['pages_text'] = __('Page','highthemes').' %CURRENT_PAGE% ' .__('of','highthemes').' %TOTAL_PAGES%';
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','highthemes');
	$pagenavi_options['last_text'] = __('Last &raquo;','highthemes');
