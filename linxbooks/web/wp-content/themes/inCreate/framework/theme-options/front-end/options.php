<div class="ht-wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<img style="display:none" src="<?php echo HT_FRAMEWORK_URL; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
		...
		<div class="save_bar"> 
			...
			<img style="display:none" src="<?php echo HT_FRAMEWORK_URL; ?>assets/images/loading-bottom.gif" class="ajax-reset-loading-img ajax-loading-img-bottom" alt="Working..." />
...
<div class="smof_footer_info">Framework Version <strong><?php echo HT_FRAMEWORK_VERSION; ?></strong></div>