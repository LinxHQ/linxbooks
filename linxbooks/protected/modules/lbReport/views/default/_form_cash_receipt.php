...
<div style="margin-bottom: 15px;">
    ...
    <?php echo CHtml::button(Yii::t('lang','Search'), array('onclick'=>'load_search_view_cash();return false;','class'=>'btn','style'=>'margin-top:-3px;')) ?>
</div>


<div id="form_view_cash_report">
        
</div>

<script>
   $('#form_view_cash_report').load('formCashReport');

   function load_search_view_cash(){
       var customer_id = $('#customer').val();
       var search_date_from = $('#search_data_from_cash').val();
       var search_date_to = $('#search_data_to').val();
      
       $('#form_view_cash_report').html('<img src="<?php echo YII::app()->baseUrl; ?>/images/loading.gif" /> Loading...');
       $('#form_view_cash_report').load('AjaxLoadFormViewCash',{customer_id:customer_id,search_date_from:search_date_from,search_date_to:search_date_to});
   } 
</script>