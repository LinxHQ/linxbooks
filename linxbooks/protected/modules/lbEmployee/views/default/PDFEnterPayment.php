...
$PDFPayment = '<table border="0" style="margin:auto; width:100%;" cellpading="0" cellpacing="0">'
            ...
            .'</table>
            <table border="1"   style="margin:auto;margin-top:50px; width:100%;" class="items table table-bordered">';
                $PDFPayment .= '<thead>
                        ...
                        <tr style="font-weight:bold;" align="center">                        
                            ...
                            <td width="100" class="lb-grid-header">'.Yii::t('lang','Balance').'</td>
...
//                        $totalAllAmount += $amount;
                    ...
                    //    $PDFPayment.='<td align="center">'.date('d-m-Y',strtotime($value->payment_date)).'</td>';
                        ...
                        $PDFPayment.='<td align="right">$'.number_format($balance,2).'</td>';
...
$PDFPayment.= '<div style="margin-left:480px; margin-top:20px; width:30%; border: 1px solid black">'
                    . '<table style="text-align:right;width:100%;">'
                        ...
                        . '</tr>'
                        . '<tr>'
                            . '<td style="text-align:left;padding:6px;"><b>Total Balance:</b></td>'
