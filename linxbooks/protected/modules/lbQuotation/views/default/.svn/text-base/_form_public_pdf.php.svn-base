...
<iframe src="<?php echo Yii::app()->createAbsoluteUrl('lbQuotation/p/'.$p); ?>" width="100%" height="280"></iframe>
<script type="text/javascript">
    function send_share_pdf(){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo Yii::app()->createAbsoluteUrl("lbQuotation/default/AjaxSendEmailQuotationSharePDF/",array('p'=>$p)); ?>',
            data:data,
